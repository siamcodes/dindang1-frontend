...
export const userRegisterView = (userObj) => async (dispatch) => {
    ...
    if(data.message){
        ...
        dispatch(alertSliceActions.showAlert({message:'User Created Successfully', variant:'alert-success'}))
        return true
    }
...
export const userLoginView = (userObj) => async (dispatch) => {
    ...
    if(data.message){
        ...
        dispatch(alertSliceActions.showAlert({message:'User Logged In Succesfully', variant:'alert-success'}))
...
export const userPasswordResetRequestView = (emailObj) => async (dispatch) => {
    ...
    if(data.message){
        ...
        dispatch(alertSliceActions.showAlert({message:'Message sent Succesfully.  Please check you inbox for further instructions', variant:'alert-success'}))
    }
}
...
export const userPasswordResetFormView = (passwordObj) => async (dispatch) => {
    ...
    if(data.message){
        ...
        dispatch(alertSliceActions.showAlert({message:'Password updated Successfully.  Please go ahead and login again', variant:'alert-success'}))
        return true
    }    
}
